...
/**
 * Displays a countdown timer based on the data-datetime attribute.
 * Updates every second and hides when the countdown reaches zero.
 * @param {string} data-datetime - The target date and time for the countdown.
 * @returns {HTMLElement} - The countdown timer element.
 */
 ...
 * This is useful for determining if the modal should scroll back to the origin element.
